...
class _WebsiteProductsScreenState extends State<WebsiteProductsScreen> {
  ...
  // Static cache to store products per website
  static final Map<int, List<dynamic>> _productCache = {};
  ...
  void initState() {
    ...
    if (_productCache.containsKey(widget.websiteId)) {
      setState(() {
        products = _productCache[widget.websiteId]!;
        isLoading = false;
      });
    }
    ...
    try {
      ...
      if (result['success'] == true && result['data'] != null) {
        ...
        if (mounted) {
          ...
          _productCache[widget.websiteId] = fetchedProducts;
        }
      } else {
  ...
  Widget _buildProductCard({
    ...
    return ModernCard(
      ...
      onTap: () {
        // Get first variation for navigation - Fixed to match Marketplace behavior
