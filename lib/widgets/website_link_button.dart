...
class WebsiteLinkButton extends StatefulWidget {
  final String domain;
  final int userId;
  ...
  @override
  _WebsiteLinkButtonState createState() => _WebsiteLinkButtonState();
}

class _WebsiteLinkButtonState extends State<WebsiteLinkButton> {
  ...
  void initState() {
    super.initState();
    print('=== WEBSITE LINK BUTTON INIT ===');
  ...
  Widget build(BuildContext context) {
    ...
    if (_isLinked) {
      return Container(
        width: double.infinity, // Take full width on mobile
        padding: const EdgeInsets.all(12),
        decoration: BoxDecoration(
        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              children: [
                Icon(Icons.link, color: Colors.green.shade600, size: 18),
                const SizedBox(width: 8),
                Text(
                  'Linked',
                  style: TextStyle(
            ...
            SizedBox(
              ...
              child: ElevatedButton.icon(
                ...
                icon: Icon(Icons.link_off, color: Colors.white, size: 16),
                label: Text(
                  'Unlink Website',
                  style: TextStyle(
                    color: Colors.white,
